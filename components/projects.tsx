...
const projects = [
    {
        ...
        description: "A React.js project featuring a modern Dashboard system which contains different Data Tables with API integration and a Two-Factor Authentication (2FA) system using Mui and React Query for data fetching..",
        image: "/dashboard.png",
      ...
      },
  {
    ...
    description: "A featured online store with cake listings, cart functionality, and filtering.",
    image: "/dakes.png",
  ...
  },
  {
    ...
    description:
      "A Next.js application for radio podcast.",
    image: "/ABR.png",
    technologies: ["React", "Next.js", "TypeScript","Tailwind css", "ReactQuery"],
  ...
  },
  {
    ...
    description: "A user tracking form built with React, Formik, Firebase, and Google Maps Integration, allowing users track, pin an address, and store geolocation data in Firestore with real-time map interactions.",
  ...
  },
  {
    id: 6,
    title: "E-Commerce Website",
    description: "A responsive cloth vendor website showcasing clothes and cart functionality.",
  ...
  },
  {
    id: 7,
    title: "E-Commerce Website",
    description: "A responsive estate management web page design showcasing different home properties, pricing and location.",
    image: "/HomeLand.png",
  ...
  },
  {
    ...
    description: "A facebook prototype webpage featuring posting, likes, friends online and more",
    image: "/chatBox.png",
  ...
  },
  {
    id: 9,
    title: "E-Commerce Website",
    description: "An e-commerce webpage design showcasing different pasteries, filtering functions and cart.",
    image: "/BestEat.png",
  ...
  },
  {
    id: 10,
    title: "E-Commerce Website",
    description: "A responsive blog post web page design showcasing different blog articles.",
    image: "/BlogPost.png",
          ...
          {projects.slice(0, visibleProjects).map((project) => (
            ...
            >
              ...
              >
                ...
                >
                  <CardMedia component="img" height="500" image={project.image} alt={project.title} />
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap", mt: 2 }}>
                      {project.technologies.map((tech) => (
                        <Chip variant="outlined" key={tech} label={tech} sx={{
                          color: "inherit",
                          fontWeight: "bold" }} />
                      ))}
                    </Box>
        ...
        {visibleProjects < projects.length && (
          <Box sx={{ display: "flex", justifyContent: "center", mt: 4 }}>
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Button variant="contained"  onClick={showMoreProjects}
              sx={{background:'linear-gradient(180deg, #E2F87B, #ff4b2b)', fontSize:'1rem'}}>
                See More
              </Button>
            </motion.div>
          </Box>
